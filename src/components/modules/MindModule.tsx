...
const MindModule: React.FC<MindModuleProps> = ({ onBack }) => {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      {/* ================= SCROLL CONTAINER ================= */}
      <div className="relative z-10 h-full overflow-y-auto pb-28">
        {/* pb-28 = safe space for footer (adjust once globally if footer height changes) */}

        <div className="max-w-md mx-auto">
          {/* ================= HEADER ================= */}
          <motion.div className="sticky top-0 bg-white/70 dark:bg-gray-900/70 backdrop-blur-md px-4 py-4 border-b dark:border-gray-800 z-20">
